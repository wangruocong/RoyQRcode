...
- (void)addCornerLineWithContext:(CGContextRef)ctx rect:(CGRect)rect{
    ...
    CGContextSetRGBStrokeColor(ctx, 255 /255.0, 255/255.0, 255/255.0, 1);//白色色
    
    
    //左上角
    CGPoint poinsTopLeftA[] = {CGPointMake(rect.origin.x - 4, rect.origin.y - 5),CGPointMake(rect.origin.x - 4 , rect.origin.y + 15)};
    CGPoint poinsTopLeftB[] = {CGPointMake(rect.origin.x - 5, rect.origin.y - 4),CGPointMake(rect.origin.x + 15, rect.origin.y - 4)};
    [self addLine:poinsTopLeftA pointB:poinsTopLeftB ctx:ctx];
    
    //左下角
    CGPoint poinsBottomLeftA[] = {CGPointMake(rect.origin.x - 4, rect.origin.y + rect.size.height - 15),CGPointMake(rect.origin.x - 4, rect.origin.y + rect.size.height + 5)};
    CGPoint poinsBottomLeftB[] = {CGPointMake(rect.origin.x - 5, rect.origin.y + rect.size.height + 4),CGPointMake(rect.origin.x + 15, rect.origin.y + rect.size.height + 4)};
    [self addLine:poinsBottomLeftA pointB:poinsBottomLeftB ctx:ctx];
    
    //右上角
    CGPoint poinsTopRightA[] = {CGPointMake(rect.origin.x + rect.size.width - 15, rect.origin.y - 4),CGPointMake(rect.origin.x + 5 + rect.size.width, rect.origin.y - 4)};
    CGPoint poinsTopRightB[] = {CGPointMake(rect.origin.x + rect.size.width + 4, rect.origin.y - 5),CGPointMake(rect.origin.x + rect.size.width + 4, rect.origin.y + 15)};
    [self addLine:poinsTopRightA pointB:poinsTopRightB ctx:ctx];
    
    CGPoint poinsBottomRightA[] = {CGPointMake(rect.origin.x + rect.size.width - 15, rect.origin.y + rect.size.height + 4),CGPointMake(rect.origin.x + rect.size.width + 5, rect.origin.y + rect.size.height + 4)};
    CGPoint poinsBottomRightB[] = {CGPointMake(rect.origin.x + rect.size.width + 4, rect.origin.y + rect.size.height - 15),CGPointMake(rect.origin.x + rect.size.width + 4, rect.origin.y + rect.size.height + 5)};
